...
<div class="contenido">
    <%
    	...
    	String idRegistro = (String) request.getAttribute("idRegistro");
    ...
    <% if (Boolean.TRUE.equals(exito)) { %>
        ...
        <div class="info">
            <p>Nº Registro: <span class="numero"><%= idRegistro != null ? idRegistro : "No disponible" %></span></p>
            <p>Fecha y hora: <span class="numero"><%= fechaHora != null ? fechaHora : "No disponible" %></span></p>
        </div>
    <% } else { %>
        <div class="ko">
